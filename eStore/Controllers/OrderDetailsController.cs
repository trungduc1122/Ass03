...
namespace eStore.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(FStoreDBAssignmentContext context)
        {
            _context = context;
        }
        ...
        {
            var fStoreDBAssignmentContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FStoreDBAssignmentContext.OrderDetail'  is null.");
            }
            var orderDetail = await _context.OrderDetail.FindAsync(id);
            if (orderDetail != null)
            {
